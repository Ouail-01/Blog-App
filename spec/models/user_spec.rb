...
RSpec.describe User, type: :model do
  subject { User.new(name: 'Ouail', photo: 'ghttps://unsplash.com/photos/6dmx8YnkPGo', bio: 'This is my bio', posts_counter: '6') }
  ...
  it 'should list three recent posts' do
    4.times do |i|
      Post.create(title: 'Hello', text: "Post number #{i}", comment_counter: 0, likes_counter: 0, author: subject)
    end
